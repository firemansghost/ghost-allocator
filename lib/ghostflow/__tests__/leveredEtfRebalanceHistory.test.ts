...
assert.strictEqual(mock.passivePressure, 58);
assert.strictEqual(mock.composite, 62);
assert.strictEqual(mock.band, 'crowded_reflexive');
const l56 = previewScoreWithLevered(56);
assert.strictEqual(l56.passivePressure, 58);
assert.strictEqual(l56.composite, 62);
assert.strictEqual(l56.band, 'crowded_reflexive');
