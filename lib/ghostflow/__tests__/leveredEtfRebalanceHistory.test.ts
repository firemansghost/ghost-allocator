...
assert.strictEqual(mock.passivePressure, 53);
assert.strictEqual(mock.composite, 60);
assert.strictEqual(mock.band, 'elevated_flow');
const l56 = previewScoreWithLevered(56);
assert.strictEqual(l56.passivePressure, 53);
assert.strictEqual(l56.composite, 60);
