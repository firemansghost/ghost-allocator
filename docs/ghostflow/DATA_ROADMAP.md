...
| **v1.7d** | Treasury Plumbing production artifact candidates | **Partial** — `treasury-futures-positioning-proxy` production JSON + loader + `ghostflow:check` ([TREASURY_BASIS_TRADE_ARTIFACT_DESIGN.md](./TREASURY_BASIS_TRADE_ARTIFACT_DESIGN.md)); `treasury-long-end-income-lens` production **deferred v1.7d.1** (FRED verification); no UI/score/`publicSignalCount` change |
...
6. **Treasury Plumbing (v1.7a–d):** [TREASURY_PLUMBING_FEASIBILITY.md](./TREASURY_PLUMBING_FEASIBILITY.md) · [TREASURY_BASIS_TRADE_ARTIFACT_DESIGN.md](./TREASURY_BASIS_TRADE_ARTIFACT_DESIGN.md) · [BOND_NEGLECT_INCOME_LENS_ARTIFACT_DESIGN.md](./BOND_NEGLECT_INCOME_LENS_ARTIFACT_DESIGN.md) — CFTC positioning **production candidate** (v1.7d, asOf 2026-05-26). Open: **FRED operator extract** → **v1.7d.1** income-lens production JSON; **v1.7e** display section. Treasury lane **separate from equity composite**; `publicSignalCount` **10** unchanged.
