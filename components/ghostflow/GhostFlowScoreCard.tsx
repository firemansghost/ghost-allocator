...
export function GhostFlowScoreCard({ data }: { data: GhostFlowDashboardData }) {
  const { score, passivePressureInputs, structuralFragilityInputs } = data;
    ...
    <section className="space-y-4" aria-labelledby="ghostflow-score-heading">
      <GlassCard className="p-5 sm:p-6">
        ...
        <p className="mt-2 text-xs text-zinc-500">
          ...
          {score.subScores.structuralFragility}). Mock inputs only. Not a forecast. Not financial advice.
        </p>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <GlassCard className="p-4 sm:p-5">
          ...
          <p className="mt-2 text-[10px] text-zinc-600">Input values are mock 0–100 proxies for v0.1.</p>
        </GlassCard>
